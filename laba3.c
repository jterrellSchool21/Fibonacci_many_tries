...
int main(){
	...
	start = clock();
	printf("Рекурсия : %d : ", fib_recur(N));
	end = clock();
	seconds = (double)(end - start) / CLOCKS_PER_SEC;
	printf("%f seconds \n", seconds);

	start = clock();
	printf("Формула  : %ld : ", fib_formula(N));
	end = clock();
	seconds = (double)(end - start) / CLOCKS_PER_SEC;
	printf("%f seconds \n", seconds);

	start = clock();
	printf("Массив   : %ld : ", fib_mass(N));
	end = clock();
	seconds = (double)(end - start) / CLOCKS_PER_SEC;
	printf("%f seconds \n", seconds);

	start = clock();
	printf("Матрицы  : %ld : ", fib_matrix(N));
	end = clock();
	seconds = (double)(end - start) / CLOCKS_PER_SEC;
	printf("%f seconds \n", seconds);
